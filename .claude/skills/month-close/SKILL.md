...
1. **Канбан месяца** — сумма физического времени за все дни месяца (`kanban-time.sh period {первое} {последнее}`)
2. **Бюджет закрыт за месяц** — сумма `Бюджет закрыт` из всех Week Report'ов месяца
3. **Мультипликатор месяца** = Бюджет закрыт / Канбан. Формат: `N.Nx`
