...
(если файл отсутствует → обновление только вручную: `IWE_ALLOW_TEMPLATE_UPDATE=1 bash /q/IWE/custom/update-with-custom.sh`, или создай вручную; продолжи по базовому
